...
public class MainActivity extends AppCompatActivity {
    ...
    EditText input;
    Spinner unit;
    TextView km,m,cm,mm,micron,nm,mile,yard,foot,inch;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        micron = findViewById(R.id.micron);
       ...
       String[] arr = {"km","m","cm","mm","micron","nm","mile","yard","foot","inch"};
    ...
    private void setkm(double km_in){
        ...
        micron.setText(String.valueOf(km_in*1000000000));
